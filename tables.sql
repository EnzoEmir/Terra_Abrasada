...
CREATE TABLE Inst_Prota (
    ...
    Mut_Cab SMALLINT NOT NULL,
    Mut_Tronco SMALLINT NOT NULL,
    Mut_Braco SMALLINT NOT NULL,
    Mut_Perna SMALLINT NOT NULL,
    Eq_Cab SMALLINT NOT NULL,
    Eq_Tronco SMALLINT NOT NULL,
    Eq_Braco SMALLINT NOT NULL,
    Eq_Perna SMALLINT NOT NULL,
    Arma_Atual SMALLINT NOT NULL,
    Save SMALLINT NOT NULL,
